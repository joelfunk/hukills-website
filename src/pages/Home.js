              ...
              <div className="col-md-6 offset-md-1">
                  <div className="tab-content" id="nav-tabContent">
                      ...
                      <div className="tab-pane fade" id="list-flooring" role="tabpanel" aria-labelledby="list-flooring-list">
                          ...
                          <h3 className="service-subtitle">Beautiful Floors That Last</h3>
                      ...
                      <div className="tab-pane fade" id="list-plumbing" role="tabpanel" aria-labelledby="list-plumbing-list">
                          ...
                          <h3 className="service-subtitle">100+ Years of Combined Experience</h3>
                      ...
                      <div className="tab-pane fade" id="list-water-heaters" role="tabpanel" aria-labelledby="list-water-heaters-list">
                          ...
                          <h3 className="service-subtitle">Hot Water When You Need It</h3>
                          ...
                          <p className="service-description">Whether your water heater is leaking, not producing enough hot water, or simply needs replacement, we can help. We'll assess your household's hot water demands and recommend energy-efficient options that save you money on utility bills. Our installations meet all local codes and come with manufacturer warranties for your peace of mind.</p>
                          <a href="#" className="btn service-btn">More</a>
                      </div>
                      <div className="tab-pane fade" id="list-drain-cleaning" role="tabpanel" aria-labelledby="list-drain-cleaning-list">
                          ...
                          <h3 className="service-subtitle">Keep Your Drains Flowing Freely</h3>
                          ...
                          <p className="service-description">Our drain cleaning services go beyond simple snaking. We use professional-grade equipment to thoroughly clean your pipes and can perform video inspections to identify the source of recurring problems. From kitchen sinks and bathroom drains to main sewer lines, we have the tools and expertise to resolve any drainage issue.</p>
                          <a href="#" className="btn service-btn">More</a>
                      </div>
                      ...
                      <div className="tab-pane fade" id="list-leak-detection" role="tabpanel" aria-labelledby="list-leak-detection-list">
                          ...
                          <h3 className="service-subtitle">Advanced Technology, Precise Results</h3>
                          <p className="service-description">Protect your property from water damage with our advanced leak detection services. Using state-of-the-art electronic equipment, we can locate hidden leaks in walls, under slabs, and underground without destructive digging. Early detection saves you money on water bills and prevents extensive damage to your property.</p>
                          <p className="service-description">Our leak detection specialists use acoustic listening devices, thermal imaging, and electronic line tracing to pinpoint the exact location of leaks. This technology allows us to find problems quickly and repair them with minimal disruption to your property, saving you time and money on restoration costs.</p>
                          <a href="#" className="btn service-btn">More</a>
                      </div>
                      ...
                      <div className="tab-pane fade" id="list-excavation" role="tabpanel" aria-labelledby="list-excavation-list">
                          ...
                          <h3 className="service-subtitle">Professional Underground Work</h3>
